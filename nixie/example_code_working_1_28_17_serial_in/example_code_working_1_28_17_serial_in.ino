...
pnt_output_string = (char*) gpstime;
	//Check the demo switch
	/*if(digitalRead(switch_pin)){
		update_serial();//test_pattern(); <<<read from serial test splice in gps data here 
	}
	else{
		update_serial();
	}
